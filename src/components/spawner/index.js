...
export const createSpawner = (world, scene, figures) => {

    const platform = figures.find(x => x.name === 'platform');
    ...
    const spawnFigure = () => {
        ...
        const y = 50;
        Figure.initFigures(scene, world, figures, [createCube.bind(null,{x,y,z})]);
    }
